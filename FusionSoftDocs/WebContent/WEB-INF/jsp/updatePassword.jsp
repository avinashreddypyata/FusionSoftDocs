...
<head>
    ...
    <link href="http://localhost:80/LoginPage/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
...
<!-- END LOGO -->
<!-- BEGIN Password FORGOT FORM -->
<div class="content">
   <!-- BEGIN FORGOT PASSWORD FORM -->
            <form class="form-horizontal" action="savePassword" id="submit_form"  method="post">
            ...
            <div class="input-icon">
                ...
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="New Password" name="password" id="submit_form_password" class="form-control"/> </div>
        </div>
        <div class="form-group">
            <label class="control-label">Confirm Password</label>
            <div class="input-icon">
                <i class="fa fa-lock"></i>
                <input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Password" name="rpassword" class="form-control"/> </div>
        </div>
...
<!-- END CORE PLUGINS -->
  <!-- BEGIN PAGE LEVEL PLUGINS -->
        ...
        <script src="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="http://localhost:80/LoginPage/assets/global/scripts/app.min.js" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="http://localhost:80/LoginPage/assets/pages/scripts/form-wizard.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME LAYOUT SCRIPTS -->
<!-- END THEME LAYOUT SCRIPTS -->
<div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; height: 185px; width: 1226px; z-index: -999999; position: fixed;"><img src="http://localhost:80/LoginPage/assets/pages/media/bg/1.jpg" style="position: absolute; display: none; margin: 0px; padding: 0px; border: none; width: auto; height: 185px; max-height: none; max-width: none; z-index: -999999; top: 0px;"></div>
</body>
