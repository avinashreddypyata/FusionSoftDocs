                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">Applications</span>
                                        </div>
                                            ...
                                            <table class="table table-bordered table-hover">
                                              <thead>
                                                                <tr>
                                                                    ...
                                                                    <th>Applicant Current Status</th>
                                                                    <th>View Profile</th>
                                                                </tr>
                                                            </thead>
                                        <tbody>
                                                               <c:forEach items="${applicants}" var="applicant">
                                                                ...
                                                                <tr class="odd gradeX">
                                                                   ...
                                                                   <td>
                                                                        <c:out value="${applicant.applicationtype}" /> 
                                                                    </td>
                                                                    <td>
                                                                        <c:out value="${applicant.currentvisastatus}" /> 
                                                                    </td>
                                                                    <td>
                                                                                       <form action="viewapplication" method="POST">
                                                                       
                                                                            <input type="hidden" value="${applicant.userid}" name="userid"></input>
                                                                            
                                                                                        <button type="submit" class="btn green btn-outline">View Profile</button>
                                                                                       </form>
                                                                                        </td>
                                                                </tr>
															</c:forEach>
