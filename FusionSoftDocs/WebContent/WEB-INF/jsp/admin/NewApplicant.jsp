...
<script src="http://localhost:854/LoginPage/assets/newapplicantformjsfiles/datepicker.js"></script>
     
    <link rel="stylesheet" type="text/css" href="http://localhost:854/LoginPage/assets/newapplicantformjsfiles/theme/default/css/default.css"
    id="theme" />
...
action="savenewapplicant" enctype="multipart/form-data" method="POST" novalidate="novalidate"
data-form="preview">
    ...
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-50-item-column" id="item4">
        ...
        <div class="fb-input-box">
          <input name="username" id="item4_email_1" type="email" maxlength="254" placeholder="applicant@domain.com"
          data-hint="" autocomplete="off" required />
        </div>
      </div>
    </div>
  </div>
...
<div class="btn-group btn-group btn-group-justified">
        ...
        <script src="http://localhost:854/LoginPage/assets/newapplicantformjsfiles/conditions.js"></script>
        <script src="http://localhost:854/LoginPage/assets/newapplicantformjsfiles/formvalidation.js"></script>
        <!--[if lt IE 9]>
