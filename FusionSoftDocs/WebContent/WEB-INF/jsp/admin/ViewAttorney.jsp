                              ...
                              <div class="portlet light bordered">
                                                            ...
                                                            <div class="form-body">
                                                             <div class="form-actions top right">
                                                                                    <a type="submit" class="btn green" href="editattorney?attorneyid=${attorney.attorneyid}">Edit Attorney</a>
                                                                                   
                                                                                </div>
                                                                
                                                                    
                                                                    
                                                                    <h3 class="form-section">ATTORNEY INFORMATION</h3>
                                                                     <div class="row">
                                                                                <div class="col-md-6">
