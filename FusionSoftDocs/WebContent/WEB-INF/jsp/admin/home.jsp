                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject font-dark bold uppercase">Attorneys</span>
                                        </div>
                                        <div class="actions">
                                            <div class="btn-group">
                                                <a class="btn dark btn-outline btn-circle btn-sm" href="addnewattorney"> Add New Attorney
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <c:forEach items="${attorneys}" var="attorney">
                                                                                        <tr>
                                                                                            <td>
                                                                       <a href = "viewattorney?attorneyid=${attorney.attorneyid}"><c:out value="${attorney.name}" /></a>  
                                                                    </td>
                                                                                            <td ><c:out value="${attorney.company}" /></td>
                                                                                            
                                                              <td ><c:out value="${attorney.email}" /></td>
                                                              <td ><c:out value="${attorney.phonenumber}" /></td>
                                                       
                                                                                           <td>
                                                                                       <form action="deleteattorney" method="POST">
                                                                       
                                                                            <input type="hidden" value="${attorney.attorneyid}" name="attorneyid"></input>
...
<![endif]-->
        ...
        <script src="http://localhost:80/LoginPage/assets/pages/scripts/table-datatables-managed.min.js" type="text/javascript"></script>
