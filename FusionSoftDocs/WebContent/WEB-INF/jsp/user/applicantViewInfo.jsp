...
<html lang="en">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                ...
                                                                <div class="tabbable-line tabbable-custom-profile">
                                                                    <ul class="nav nav-tabs">
                                                                        <li class="active">
                                                                            <a href="#tab_1_11" data-toggle="tab"> Documents </a>
                                                                        </li>
                                                                    </ul>
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <c:out value="${document.doctitle}" /> 
                                                                            ...
                                                                            <form id="deleteexpdoc" method="post" action="deleteDoc">
    <input type="hidden" name="docid" value="${document.docid}" />
                                                                            ...
                                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                                ...
                                                                                <li>
                                                                                    <a href="#" onclick="document.getElementById('deleteexpdoc').submit(); return false;">
                                    ...
                                    <form:input type="text" path="description" id="description" class="form-control input-sm" placeholder="Describe the Doc"/>
                                        <p class="help-block">Upload Experience Documents</p>
                                                                        ...
                                                                        <c:out value="${document.doctitle}" /> 
                                                                            ...
                                                                            <form id="deleteedudoc" method="post" action="deleteDoc">
    <input type="hidden" name="docid" value="${document.docid}" />
</form>
                                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                                <li>
                                                                                ...
                                                                                <li>
                                                                                    <a href="#" onclick="document.getElementById('deleteedudoc').submit(); return false;">
                                                                                        <i class="icon-tag"></i> Delete </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                        ...
                                                                        <c:out value="${document.doctitle}" /> 
                                                                            ...
                                                                            <button class="btn btn-xs green dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false"> Actions
                                                                                <i class="fa fa-angle-down"></i>
                                                                                                                     ...
                                                                                                                     <form id="deletemisdoc" method="post" action="deleteDoc">
    <input type="hidden" name="docid" value="${document.docid}" />
</form>
                                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                                <li>
                                                                                ...
                                                                                <li>
                                                                                    <a href="#" onclick="document.getElementById('deletemisdoc').submit(); return false;">
                                                                                        <i class="icon-tag"></i> Delete </a>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
