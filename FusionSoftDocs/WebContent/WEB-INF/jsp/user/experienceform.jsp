...
<![endif]-->
        ...
        <script src="http://localhost:875/LoginPage/assets/layouts/layout/scripts/layout.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/layouts/layout/scripts/demo.min.js" type="text/javascript"></script>
