                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="mt-radio-list">
                                                                                <label class="mt-radio mt-radio-outline"> Yes
                                                                                    <form:radiobutton   value="Yes"  path="usvisit" id="yes"/>
                                                                                    <span></span>
                                                                                </label>
                                                                                <label class="mt-radio mt-radio-outline"> No
                                                                                    <form:radiobutton  value="No"  path="usvisit" id="no" />
                                                                                    <span></span>
                                                                                </label>
                                                                            </div>
                                                                        </div>
...
<script src="http://localhost:80/LoginPage/assets/applicationformjsfile/applicationformjs.js" type="text/javascript"></script>
