    ...
    <div class="column ui-sortable" id="column1">
      ...
      <div class="fb-item fb-50-item-column" id="item2">
        ...
        <div class="fb-input-box">
          <form:input name="employer" id="item2_text_1" required type="text" maxlength="254"
      ...
      <div class="fb-item fb-50-item-column" id="item3">
        ...
        <div class="fb-input-box">
          <form:input name="city" id="item3_text_1" required type="text" maxlength="254"
      ...
      <div class="fb-item fb-50-item-column" id="item4">
        ...
        <div class="fb-input-box">
          <form:input name="state" id="item4_text_1" required type="text" maxlength="254"
