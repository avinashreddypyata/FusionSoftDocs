...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost:80/LoginPage/assets/visaCertificationformjsfiles/theme/default/css/default.css"
    id="theme" />
                            ...
                            <div class="page-content">
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <span class="caption-subject bold uppercase">Certification Details</span>
                                    </div>
...
<thead>
                                                            ...
                                                            <tbody>
                                                              ...
                                                              <form action="editcertificate" method="POST">
                                                              <input type="hidden" value="${certificationdetail.certificationId}" name="certificationid">
...
<form action="deletecertificate" method="POST">
                                        ...
                                        <h3 class="form-section">Certificate Documents Uploaded</h3>
 ...
 <div class="btn-group btn-group btn-group-justified">
                                                                  <a href="editorcreatenewcertificate" class="btn green"><i class="fa fa-plus"></i> Add More Certificate Details </a>
                                                                    <a href="logout" class="btn purple"> Save Progress And Return Later </a>
                                                                    <a href="applicantdocument" class="btn green"> Continue To Next Section</a>
                                                                </div>
                                </div>
                            </div>
                                                </div>
