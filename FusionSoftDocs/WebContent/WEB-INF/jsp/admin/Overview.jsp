                                    ...
                                    <div class="timeline">
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-badge">
                                                <img class="timeline-badge-userpic" src="http://localhost:80/LoginPage/assets/layouts/layout3/img/user.jpg"> </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-badge">
                                                <img class="timeline-badge-userpic" src="http://localhost:80/LoginPage/assets/pages/media/users/attorney.jpg"> </div>
                                            <div class="timeline-body">
                                                <div class="timeline-body-arrow"> </div>
                                                <div class="timeline-body-head">
                                                    <div class="timeline-body-head-caption">
                                                        <a href="javascript:;" class="timeline-body-title font-blue-madison">Attorney</a>
                                                        <span class="timeline-body-time font-grey-cascade">${applicant.attorneyverificationstatus }</span>
                                                    </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-badge">
                                                <img class="timeline-badge-userpic" src="http://localhost:80/LoginPage/assets/pages/media/users/education.png"> </div>
                                            <div class="timeline-body">
                                                <div class="timeline-body-arrow"> </div>
                                                <div class="timeline-body-head">
                                                    <div class="timeline-body-head-caption">
                                                        <a href="javascript:;" class="timeline-body-title font-blue-madison">Education Evaluation</a>
                                                         <span class="timeline-body-time font-grey-cascade">${applicant.educationevaluationstatus}</span>
                                                    </div>
                                                ...
                                                <div class="timeline-body-content">
                                                    ...
                                                    <c:forEach items="${educationevaluationteam}" var="educationevaluation">
                                                     ...
                                                     <p><a href="assigntoeducationevaluation?educationevaluationid=${educationevaluation.educationevaluationid}&applicantid=${applicant.userid}" class="btn green btn-outline">Assign To Education Evaluation Team ${educationevaluation.name}</a></p>
