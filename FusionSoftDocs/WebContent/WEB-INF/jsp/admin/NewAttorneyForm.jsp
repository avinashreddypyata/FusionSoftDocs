                              ...
                              <div class="portlet light bordered">
                                                                <div class="portlet-title">
                                                                    <div class="caption">
                                                                        ...
                                                                        <span class="caption-subject font-blue-hoki bold uppercase">New Attorney</span>
                                                                ...
                                                                <div class="portlet-body form">
                                                                    <!-- BEGIN FORM-->
                                                                     <form:form action="saveorupdatenewattorney" method="POST" class="horizontal-form" id="form_sample_1" enctype="multipart/form-data" modelAttribute="attorney">
                                                            <div class="form-body">
                                                              <form:hidden path="attorneyid" value="${attorney.attorneyid}"/>
                                                                
                                                                    
                                                                    
                                                                    <h3 class="form-section">Add New Attorney</h3>
                                                                     <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Name</label>
                                                                                        <span class="required"> * </span>
                                                                                        <form:input type="text"  data-required = "data-required" id="name" path="name" class="form-control" placeholder="Attorney Name"/>
