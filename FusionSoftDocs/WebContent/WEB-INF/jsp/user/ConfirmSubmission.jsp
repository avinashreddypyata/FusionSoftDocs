...
<script src="http://localhost:854/LoginPage/assets/documentformjsfiles/datepicker.js"></script>
     
    <link rel="stylesheet" type="text/css" href="http://localhost:854/LoginPage/assets/documentformjsfiles/theme/default/css/default.css"
    id="theme" />
...
<div class="btn-group btn-group btn-group-justified"> <a href="certificateDetails" class="btn red"> Back </a>
        ...
        <script src="http://localhost:854/LoginPage/assets/documentformjsfiles/formvalidation.js"></script>
        <!--[if lt IE 9]>
...
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
            ...
            <script src="http://localhost:854/LoginPage/assets/pages/scripts/ui-buttons.min.js" type="text/javascript"></script>
