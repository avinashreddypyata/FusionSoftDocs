...
<html lang="en">
    ...
    <head>
        ...
        <!-- BEGIN PAGE LEVEL PLUGINS -->
         <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-timepicker/css/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/clockface/css/clockface.css" rel="stylesheet" type="text/css" />
        ...
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="http://localhost:80/LoginPage/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-datepicker/css/bootstrap-datepicker3.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost:80/LoginPage/assets/global/plugins/bootstrap-markdown/css/bootstrap-markdown.min.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost:80/LoginPage/assets/passportformjsfiles/theme/default/css/default.css"
    id="theme" />
                              ...
                              <div class="portlet light bordered">
                                                                <div class="portlet-title">
                                                                    <div class="caption">
                                                                        ...
                                                                        <span class="caption-subject font-blue-hoki bold uppercase">New EducationEvaluation</span>
                                                                ...
                                                                <div class="portlet-body form">
                                                                    <!-- BEGIN FORM-->
                                                                     <form action="editmember" method="POST" class="horizontal-form" id="form_sample_1" enctype="multipart/form-data">
                                                            <div class="form-body">
                                                             <div class="form-actions top right">
                                                                                    <a type="submit" class="btn green" href="editeducationevaluation?educationevaluationid=${educationevaluation.educationevaluationid}">Edit Education Evaluation</a>
                                                                                   
                                                                                </div>
                                                                
                                                                    
                                                                    
                                                                    <h3 class="form-section">Education Evaluation Information</h3>
                                                                     <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                        <label class="control-label">Full Name</label>
                                                                                        
                                                                                        <p>${educationevaluation.name}</p>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                      ...
                                                                                      <p>${educationevaluation.phonenumber}</p>
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                    <div class="form-group">
                                                                                       ...
                                                                                       <p>${educationevaluation.company}</p>
