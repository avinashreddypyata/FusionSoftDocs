...
<html lang="en">
    ...
    <head>
        ...
        <link href="http://localhost:875/LoginPage/assets/pages/css/experience-2.min.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="page-content">
                                <div class="container">
                                 ...
                                 <div class="tab-content">
                                        ...
                                        <form:input name="userid" type="hidden" value="${profile.userid}" path="userid"/>
                                        <form:input name="doctype" type="hidden" value="experience" path="doctype"/>
                                        ...
                                        <p class="help-block">Upload Experience Documents</p>
                                                                        ...
                                                                        <c:out value="${document.doctitle}" /> 
                                                                            ...
                                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                               ...
                                                                               <form:form method="POST" modelAttribute="fileBucket" enctype="multipart/form-data" class="form-horizontal" action="uploaddocument">
                                        <form:input name="userid" type="hidden" value="${profile.userid}" path="userid"/>
                                        <form:input name="doctype" type="hidden" value="educational" path="doctype"/>
                                        <div class="form-group">
                                     <label for="exampleInputFile1">File input</label>
                                    <form:input type="file" id="exampleInputFile1" path="file"/>
                                    <form:input type="text" path="description" id="description" class="form-control input-medium" placeholder="Describe the Doc"/>
                                        <p class="help-block">Upload Education Documents Only</p>
                                                                        ...
                                                                        <c:out value="${document.doctitle}" /> 
                                                                            ...
                                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                                ...
                                                                                <form:form method="POST" modelAttribute="fileBucket" enctype="multipart/form-data" class="form-horizontal" action="uploaddocument">
                                        <form:input name="userid" type="hidden" value="${profile.userid}" path="userid"/>
                                        <form:input name="doctype" type="hidden" value="miscellaneous" path="doctype"/>
                                        <div class="form-group">
                                     <label for="exampleInputFile1">File input</label>
                                    <form:input type="file" id="exampleInputFile1" path="file"/>
                                    <form:input type="text" path="description" id="description" class="form-control input-medium" placeholder="Describe the Doc"/>
                                        <p class="help-block">Upload Only Documents Other Than Experience and Education</p>
    </div>        
                                                                                           <div class="row">
                                                                              <div class="form-actions floatRight">
                                                                           <button type="submit" class="btn green"> Upload </button>
...
<![endif]-->
           <script src="http://localhost:875/LoginPage/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
            ...
            <!-- END CORE PLUGINS -->
            <!-- BEGIN PAGE LEVEL PLUGINS -->
            <script src="http://localhost:875/LoginPage/assets/global/scripts/datatable.js" type="text/javascript"></script>
            <script src="http://localhost:875/LoginPage/assets/global/plugins/datatables/datatables.min.js" type="text/javascript"></script>
            <script src="http://localhost:875/LoginPage/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap.js" type="text/javascript"></script>
<script src="http://localhost:875/LoginPage/assets/global/plugins/moment.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/global/plugins/bootstrap-timepicker/js/bootstrap-timepicker.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/global/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/global/plugins/clockface/js/clockface.js" type="text/javascript"></script>
            <!-- END PAGE LEVEL PLUGINS -->
            <!-- BEGIN THEME GLOBAL SCRIPTS -->
            <script src="http://localhost:875/LoginPage/assets/global/scripts/app.min.js" type="text/javascript"></script>
            <!-- END THEME GLOBAL SCRIPTS -->
            <!-- BEGIN PAGE LEVEL SCRIPTS -->
            <script src="http://localhost:875/LoginPage/assets/pages/scripts/table-datatables-colreorder.min.js" type="text/javascript"></script>
            <script src="http://localhost:875/LoginPage/assets/pages/scripts/components-date-time-pickers.min.js" type="text/javascript"></script>
            <!-- END PAGE LEVEL SCRIPTS -->
            <!-- BEGIN THEME LAYOUT SCRIPTS -->
            <script src="http://localhost:875/LoginPage/assets/layouts/layout2/scripts/layout.min.js" type="text/javascript"></script>
            <script src="http://localhost:875/LoginPage/assets/layouts/layout2/scripts/demo.min.js" type="text/javascript"></script>
