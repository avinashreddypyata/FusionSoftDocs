...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="http://localhost:80/LoginPage/assets/visaEducationformjsfiles/theme/default/css/default.css"
    id="theme" />
...
<form action="deleteeducation" method="POST">
                                        ...
                                        <h3 class="form-section">Education Documents Uploaded</h3>
