...
<html lang="en">
    ...
    <head>
        ...
        <link href="http://localhost:875/LoginPage/assets/global/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="http://localhost:875/LoginPage/assets/global/css/plugins-md.min.css" rel="stylesheet" type="text/css" />
                                    ...
                                    <ul class="nav navbar-nav pull-right">
                                        ...
                                        <li class="dropdown dropdown-user dropdown-dark">
                                            <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                                <img alt="" class="img-circle" src="http://localhost:875/LoginPage/assets/layouts/layout3/img/admin.png">
...
<![endif]-->
        ...
        <script src="http://localhost:875/LoginPage/assets/pages/scripts/table-datatables-rowreorder.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="http://localhost:875/LoginPage/assets/layouts/layout4/scripts/layout.min.js" type="text/javascript"></script>
        <script src="http://localhost:875/LoginPage/assets/layouts/layout4/scripts/demo.min.js" type="text/javascript"></script>
